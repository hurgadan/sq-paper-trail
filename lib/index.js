...
exports.init = (sequelize, optionsArg) => {
	...
	const defaultOptions = {
		...
		mysql: false,
		disablePaperTrailByDefault: false
	};
...
console.log(`disablePaperTrailByDefault: ${options.disablePaperTrailByDefault}`)
console.log(`enablePaperTrail: ${options.enablePaperTrail}`)
console.log(options.disablePaperTrailByDefault === true && opt.enablePaperTrail !== true)

			if(options.disablePaperTrailByDefault === true && opt.enablePaperTrail !== true) {
				if (options.debug) {
					log('disablePaperTrailByDefault opt: is true, enablePaperTrail (model) is not true, so not logging');
				}
				return;
			}
